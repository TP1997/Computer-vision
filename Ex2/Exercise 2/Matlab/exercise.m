...
% Answer
% Size of the image is 384 x 512 x 3
% The last dimension size refers to the number of color channels
...
% Load an image
root="/home/tuomas/Python/DATA.ML.300/Ex2/Exercise 2/Matlab/"
im = rgb2gray(im2single(imread(root+'data/dots.jpg'))) ;
