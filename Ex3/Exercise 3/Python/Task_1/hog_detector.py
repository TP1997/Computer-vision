...
os.chdir('/home/tuomas/Python/DATA.ML.300/Ex3/Exercise 3/Python/Task_1/')
...
# https://docs.opencv.org/master/d5/32d33/structcv_1_1HOGDescriptor.html#a91e56a2c317392e50fbaa2f5dc78d30b
#
...
while cv2.waitKey(delay) != ord('q'):
    try:
        ...
        start = time.time()
        detections, x = hog.detectMultiScale(img,
                                             winStride=winStride,
                                             padding=padding,
                                             scale=scale,
