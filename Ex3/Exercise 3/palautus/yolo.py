...
os.chdir('/home/tuomas/Python/DATA.ML.300/Ex3/Exercise 3/Python/Task_2-3/yolo')
cwd = os.getcwd()
weights = os.path.join(cwd, "yolov3.weights") #"yolov3-tiny.weights"
model_dir = os.path.join(cwd, "cfg/yolov3.cfg") #"cfg/yolov3-tiny.cfg"
...
while True:
    ...
    for out in outs:
        for detection in out:
            ...
            class_id = np.argmax(scores) #0 # replace me
            confidence =float(scores[class_id]) #0 # replace me 
            ##your-code-ends-here
