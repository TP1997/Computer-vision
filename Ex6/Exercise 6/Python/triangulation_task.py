...
import sys
sys.path.insert(0,'/home/tuomas/Python/DATA.ML.300/Ex6/Exercise 6/Python')
from trianglin import trianglin
import os

# Visualization of three point correspondences in both images
os.chdir('/home/tuomas/Python/DATA.ML.300/Ex6/Exercise 6/Python')
...
M_cart = M[:-1]/M[-1]
N_cart = N[:-1]/N[-1]
picture_w_mm = norm(L-M)
picture_h_mm = norm(L-N)
##-your-code-ends-here-##
